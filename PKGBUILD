...
DLAGENTS=("https::/usr/bin/curl -L -H 'Accept: application/octet-stream' -H 'X-GitHub-Api-Version: 2022-11-28' https://api.github.com/repos/akiyosi/goneovim/releases/assets/109357358 --output $_archive")
